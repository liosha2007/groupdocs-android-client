...
public class LoadSharedDocumentsResponse implements Serializable {
    private LoadSharedDocumentsResult result = null;
    private String status = null;
    private String error_message = null;
    private Long composedOn = null;

    public LoadSharedDocumentsResult getResult() {
        return result;
    }

    public void setResult(LoadSharedDocumentsResult result) {
        this.result = result;
    }
    ...
    public boolean equals(Object o) {
        ...
        LoadSharedDocumentsResponse that = (LoadSharedDocumentsResponse) o;
    ...
    public String toString() {
        ...
        sb.append("LoadSharedDocumentsResponse");
