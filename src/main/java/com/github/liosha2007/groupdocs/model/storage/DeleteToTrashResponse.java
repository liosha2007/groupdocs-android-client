...
public class DeleteToTrashResponse implements Serializable {
    private DeleteToTrashResult result = null;
    private String status = null;
    private String error_message = null;
    private Long composedOn = null;

    public DeleteToTrashResult getResult() {
        return result;
    }

    public void setResult(DeleteToTrashResult result) {
        this.result = result;
    }
    ...
    public boolean equals(Object o) {
        ...
        DeleteToTrashResponse that = (DeleteToTrashResponse) o;
    ...
    public String toString() {
        ...
        sb.append("DeleteToTrashResponse");
