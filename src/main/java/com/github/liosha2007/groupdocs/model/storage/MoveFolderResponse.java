...
public class MoveFolderResponse implements Serializable {
    private MoveFolderResult result = null;
    private String status = null;
    private String error_message = null;
    private Long composedOn = null;

    public MoveFolderResult getResult() {
        return result;
    }

    public void setResult(MoveFolderResult result) {
        this.result = result;
    }
    ...
    public boolean equals(Object o) {
        ...
        MoveFolderResponse that = (MoveFolderResponse) o;
