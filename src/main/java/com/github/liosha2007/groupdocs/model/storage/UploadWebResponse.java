...
public class UploadWebResponse implements Serializable {
    private UploadWebResult result = null;
    private String status = null;
    private String error_message = null;
    private Long composedOn = null;

    public UploadWebResult getResult() {
        return result;
    }

    public void setResult(UploadWebResult result) {
        this.result = result;
    }
    ...
    public boolean equals(Object o) {
        ...
        UploadWebResponse that = (UploadWebResponse) o;
